...
namespace Yoo.Core.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IOrderService, OrderService>();
            services.AddScoped<SecurityHashVerificationAttribute>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Yoo.Core.Api", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Yoo.Core.Api v1"));
            }
